...
def q17
  ...
  user1 = UserQ17.new(name: "よしだ", age: 22, gender: "男", admin: true)
  user2 = UserQ17.new(name: "あじー", age: 32, gender: "女", admin: false)
...
class Zoo
  ...
  def info_entry_fee(user) 
    ...
    entry_fee = 
    case user.age
    when 0..5 then @entry_fee_infant
    when 6..12 then @entry_fee_children
    when 13..64 then @entry_fee_adult
    when 65..120 then @entry_fee_senior
    end
